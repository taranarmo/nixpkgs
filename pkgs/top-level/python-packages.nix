...
self: super: with self; {
  ...
  aiologic = callPackage ../development/python-modules/aiologic { };
  ...
  airbyte-api = callPackage ../development/python-modules/airbyte-api { };
  ...
  impyla = callPackage ../development/python-modules/impyla { };
  ...
  kylinpy = callPackage ../development/python-modules/kylinpy { };
