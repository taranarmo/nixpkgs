# Warning: generated by update-providers.py, do not update manually
{
  ...
  apache_flink = {
    deps = [ "aiofiles" "asgiref" "cryptography" "google-re2" "kubernetes" "kubernetes-asyncio" ];
  ...
  apache_spark = {
    deps = [ "aiofiles" "asgiref" "cryptography" "google-re2" "grpcio-status" "kubernetes" "kubernetes-asyncio" "pyspark" ];
  ...
  celery = {
    deps = [ "aiofiles" "asgiref" "cryptography" "flower" "google-re2" "kubernetes" "kubernetes-asyncio" ];
    imports = [  ];
  };
  cloudant = {
    deps = [  ];
  ...
  cncf_kubernetes = {
    deps = [ "aiofiles" "asgiref" "cryptography" "google-re2" "kubernetes" "kubernetes-asyncio" ];
    imports = [ "airflow.providers.cncf.kubernetes.hooks.kubernetes" "airflow.providers.cncf.kubernetes.operators.custom_object_launcher" "airflow.providers.cncf.kubernetes.operators.job" "airflow.providers.cncf.kubernetes.operators.pod" "airflow.providers.cncf.kubernetes.operators.resource" "airflow.providers.cncf.kubernetes.operators.spark_kubernetes" ];
  };
  cohere = {
    deps = [ "cohere" ];
  ...
  common_sql = {
    deps = [ "attrs" "more-itertools" "sqlparse" ];
    imports = [ "airflow.providers.common.sql.hooks.sql" "airflow.providers.common.sql.operators.sql" ];
  };
  databricks = {
    deps = [ "aiohttp" "databricks-sql-connector" "mergedeep" "pandas" "pyarrow" "requests" ];
  ...
  fab = {
    deps = [ "flask" "flask-appbuilder" "flask-login" "google-re2" "jmespath" ];
    imports = [  ];
  };
  facebook = {
    deps = [  ];
  ...
  ydb = {
    deps = [  ];
    imports = [ "airflow.providers.ydb.hooks._vendor.dbapi.connection" "airflow.providers.ydb.hooks._vendor.dbapi.constants" "airflow.providers.ydb.hooks._vendor.dbapi.cursor" "airflow.providers.ydb.hooks._vendor.dbapi.errors" "airflow.providers.ydb.hooks.ydb" "airflow.providers.ydb.operators.ydb" ];
  };
  zendesk = {
    deps = [  ];
