    ...
    packageOverrides = pySelf: pySuper: {
      smmap = pySuper.smmap.overridePythonAttrs (o: rec {
        ...
        src = fetchFromGitHub {
          ...
          hash = "sha256-94mBBn0Z8UjY18VnG8M26xfBWxZPnlqfJLcRBq9xt9c=";
        };
      });
      trove-classifiers = pySuper.trove-classifiers.overridePythonAttrs (o: rec {
        ...
        src = fetchFromGitHub {
          owner = "pypa";
          repo = "trove-classifiers";
          rev = "refs/tags/${version}";
          hash = "sha256-g2DnyPRYD0I5RbbC6oMtwj5yv42LXtIxu5buCUbDNjQ=";
        };
      });
      ...
      #      --replace-warning '[tool.pytest.ini_options]' '[tool.notpytest.ini_options]'
      #  '';
      #});
